 ...
 */
public class EncryptInjector implements Injector {
    private com.google.inject.Injector m_injector;

    public EncryptInjector() {
        try {
    ...
    private static class ApolloModule extends AbstractModule {
        ...
        protected void configure() {
            ...
            // 修改为加载自定义的 EncryptConfigFactory
            bind(ConfigFactory.class).to(EncryptConfigFactory.class).in(Singleton.class);
